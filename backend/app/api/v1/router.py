...
from app.api.v1.endpoints import health, predictions, analytics, export, auth, translate, comments, outbreaks, medicine

router = APIRouter()

router.include_router(health.router, tags=["Health"])
router.include_router(health.router, prefix="/api/v1", tags=["Health"])
...
router.include_router(medicine.router, prefix="/api/v1", tags=["Medicine"])
